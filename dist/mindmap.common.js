...
var MindMapvue_type_script_lang_ts_MindMap = /*#__PURE__*/function (_Vue) {
  ...
  _createClass(MindMap, [{
    ...
    value: function appendNode(enter) {
      ...
      var foreignDiv = foreign.append('xhtml:div').attr('contenteditable', false).attr('class', function (d) {
        var _d$data$classNames;

        return (_d$data$classNames = d.data.classNames) === null || _d$data$classNames === void 0 ? void 0 : _d$data$classNames.join(' ');
      }).text(function (d) {
        return d.data.name;
      });
...
__decorate([Prop({
  default: true
}), __metadata("design:type", Boolean)], MindMapvue_type_script_lang_ts_MindMap.prototype, "showNodeRemove", void 0);
